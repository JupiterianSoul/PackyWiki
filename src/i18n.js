...
const STRINGS = {
  en: {
    ...
    settingsMusic: 'Music',
    settingsMusicNote: 'Three found lounge tracks on a quiet loop. By Kevin MacLeod and Antti Luode (CC BY).',
  ...
  fr: {
    ...
    settingsMusicNote: 'Trois morceaux lounge trouvés, en boucle discrète. Par Kevin MacLeod et Antti Luode (CC BY).',
