...
const STRINGS = {
  en: {
    ...
    settingsResetNote: 'Ends this save completely: every card, every Buckarooz, every booster, your level, your achievements and the codes you have redeemed. Secret codes can be redeemed again afterwards. This cannot be undone.',
  ...
  fr: {
    ...
    settingsReset: 'Réinitialiser toute la progression',
    settingsResetNote: 'Met fin à cette sauvegarde : chaque carte, chaque Buckarooz, chaque booster, votre niveau, vos succès et les codes que vous avez utilisés. Les codes secrets pourront être utilisés à nouveau ensuite. Action irréversible.',
