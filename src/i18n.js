...
const STRINGS = {
  en: {
    ...
    updateApk: 'A newer Wiklodo is out. This one keeps playing but stops syncing until it is updated.',
  ...
  fr: {
    ...
    updateApk: 'Un Wiklodo plus récent est sorti. Celui-ci continue de fonctionner mais ne se synchronise plus tant qu’il n’est pas mis à jour.',
    updateWeb: 'Un Wiklodo plus récent est sorti.',
    updateGet: 'Télécharger',
