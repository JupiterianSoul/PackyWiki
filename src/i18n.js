...
const STRINGS = {
  en: {
    ...
    claimFree: 'Take',
    freeTaken: 'Taken',
    freeNote: 'One of each, once per restock.',
    ...
    settingsSound: 'Sound',
    settingsSoundNote: 'Every sound in the app is generated live rather than played from a file.',
    settingsFlash: 'Screen flash on rare pulls',
    settingsFlashNote: 'The bright flash when something good comes out of a pack.',
    settingsLowPower: 'Battery saver',
    settingsLowPowerNote: 'Stops the continuous shine, glow and drift animations. The app draws far less and the phone stays cooler.',
    settingsHints: 'On-screen hints',
    settingsHintsNote: 'The lines explaining what to swipe and where.',
    settingsLanguage: 'Language',
    settingsLanguageNote: 'Chosen once, at first launch. Cards are stored in the language they were pulled in, so switching later would leave a binder in two languages.',
    settingsData: 'Data',
    settingsReset: 'Erase everything',
    settingsResetNote: 'Deletes your cards, money, boosters and progress from this device. There is no undo.',
  ...
  fr: {
    ...
    claimFree: 'Prendre',
    freeTaken: 'Pris',
    freeNote: 'Un de chaque, une fois par réassort.',
    ...
    settingsSound: 'Son',
    settingsSoundNote: 'Tous les sons sont générés en direct, aucun fichier audio n’est utilisé.',
    settingsFlash: 'Flash lors des tirages rares',
    settingsFlashNote: 'L’éclair lumineux quand une belle carte sort du booster.',
    settingsLowPower: 'Économie de batterie',
    settingsLowPowerNote: 'Arrête les reflets, halos et animations continus. L’application dessine beaucoup moins et le téléphone chauffe moins.',
    settingsHints: 'Indications à l’écran',
    settingsHintsNote: 'Les phrases qui expliquent quoi glisser et où.',
    settingsLanguage: 'Langue',
    settingsLanguageNote: 'Choisie une seule fois, au premier lancement. Les cartes sont enregistrées dans la langue du tirage : changer maintenant laisserait un classeur bilingue.',
    settingsData: 'Données',
    settingsReset: 'Tout effacer',
    settingsResetNote: 'Supprime vos cartes, votre argent, vos boosters et votre progression sur cet appareil. Aucun retour en arrière.',
