...
const STRINGS = {
  en: {
    ...
    badgesNone: 'Nothing earned yet. The hardest achievements forge them.',

    // the market
    tabMarket: 'Market',
    marketIntro: 'Put cards up for auction. When the clock runs out, the highest bid takes the card.',
    marketBrowse: 'Auctions',
    marketMine: 'Mine',
    marketSell: 'Put a card up for auction',
    marketLoading: 'Opening the floor...',
    marketEmpty: 'Nothing on the block right now. Put something up.',
    marketEmptyMine: 'No sales and no bids of yours yet.',
  ...
  fr: {
    ...
    badgesNone: 'Rien d’obtenu pour le moment. Les succès les plus durs les forgent.',

    // le marché
    tabMarket: 'Marché',
    marketIntro: 'Mettez des cartes aux enchères. À la fin du compte à rebours, la mise la plus haute emporte la carte.',
    marketBrowse: 'Enchères',
    marketMine: 'Les miennes',
    marketSell: 'Mettre une carte aux enchères',
    marketLoading: 'Ouverture de la salle...',
    marketEmpty: 'Rien aux enchères pour le moment. Proposez quelque chose.',
    marketEmptyMine: 'Aucune vente ni mise de votre part pour le moment.',
