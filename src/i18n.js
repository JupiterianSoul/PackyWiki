...
const STRINGS = {
  en: {
    ...
    quizNoKey: 'The quiz needs your own Groq API key to write its questions. Paste one in Settings and come back.',
    quizGoSettings: 'Open Settings',
    ...
    quizKeyBad: 'That key was refused. Check it in Settings.',
    quizKeySaved: 'Quiz key saved on this device',
    quizKeyCleared: 'Quiz key removed',
    settingsQuizKey: 'Quiz key (Groq)',
    settingsQuizKeyNote: 'Your own Groq API key powers the quiz. It never leaves this device.',
  ...
  fr: {
    ...
    quizNoKey: 'Le quiz a besoin de votre propre clé API Groq pour écrire ses questions. Collez-la dans les réglages puis revenez.',
    quizGoSettings: 'Ouvrir les réglages',
    ...
    quizKeyBad: 'Cette clé a été refusée. Vérifiez-la dans les réglages.',
    quizKeySaved: 'Clé du quiz enregistrée sur cet appareil',
    quizKeyCleared: 'Clé du quiz supprimée',
    settingsQuizKey: 'Clé du quiz (Groq)',
    settingsQuizKeyNote: 'Votre propre clé API Groq alimente le quiz. Elle ne quitte jamais cet appareil.',
