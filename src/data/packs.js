...
export const THEME_PACKS = [
     ...
     the length of the roll. */
  {
    ...
    titles: {
      en: [
            'Franz Reichelt', 'Garry Hoy', 'Clement Vallandigham', 'Allan Pinkerton', 'Aeschylus',
            'Draco (lawgiver)', 'Chrysippus', 'Adolf Frederick, King of Sweden', 'Isadora Duncan',
            'Jack Daniel', 'Sherwood Anderson', 'Jerome Irving Rodale', 'Tycho Brahe', 'Attila',
            'Henry Hall (soldier)', 'Bobby Leach', 'Sam Patch', 'Karel Soucek', 'Robert Overacker',
            'Jimi Heselden', 'Michael Anderson Godwin', 'Jim Fixx', 'Arrichion', 'Pope Adrian IV',
            'Sigurd the Mighty', 'Béla I of Hungary', 'Martin of Aragon',
            'Frederick I, Holy Roman Emperor', 'Fulk, King of Jerusalem', 'Thomas Midgley Jr.',
            'Horace Wells', 'Alexander Bogdanov', 'Marie Curie', 'Otto Lilienthal', 'John Sedgwick',
            'Basil Brown', 'Michael Rockefeller', 'Garrett Morgan', 'Marcus Garvey', 'Émile Cohl',
            'Hypatia', 'Empedocles', 'Zeuxis', 'Pietro Aretino', 'Hans Steininger', 'Qin Shi Huang',
            'George Plantagenet, 1st Duke of Clarence', 'Edward II of England', 'Henry I of England',
            'Charles VIII of France', 'Louis III of France', 'John of Bohemia', 'William the Conqueror',
            'Alexander I of Greece', 'Zachary Taylor', 'William Henry Harrison', 'Alexander Hamilton',
            'Button Gwinnett', 'Grigori Rasputin', 'Francis Bacon', 'Kurt Gödel', 'Harry Houdini',
            'Jean-François Pilâtre de Rozier', 'Sophie Blanchard', 'Robert Cocking', 'Henry Winstanley',
            'Salomon August Andrée', 'Robert Falcon Scott', 'George Mallory', 'Percy Pilcher',
            'Aurel Vlaicu', 'Thomas Selfridge', 'Wan Hu', 'AVE Mizar', 'Mary Ward (scientist)',
            'Bridget Driscoll', 'Larry Walters', 'Donald Campbell', 'Jessi Combs', 'Dale Earnhardt',
            'Gilles Villeneuve', 'Ayrton Senna', 'Louis Slotin', 'Harry Daghlian', 'Hisashi Ouchi',
            'Eben Byers', 'Clarence Dally', 'Radium Girls', 'Jack Parsons', 'Timothy Treadwell',
            'Steve Irwin', 'Karl Wallenda', 'Dan Osman', 'Christopher McCandless', 'Jeff Buckley',
            'Dennis Wilson', 'Natalie Wood', 'Steve Fossett', 'John Denver', 'Aaliyah', 'Buddy Holly',
            'Otis Redding', 'Terry Kath', 'Jon-Erik Hexum', 'Brandon Lee', 'Vic Morrow', 'Owen Hart',
            'Bandō Mitsugorō VIII', 'Tennessee Williams', 'Frank Hayes (jockey)', 'Ray Chapman',
            'Vladimir Smirnov (fencer)', 'Duk Koo Kim', 'Bill Masterton', 'Elisa Lam', 'Ryan Dunn',
            'David Carradine', 'Michael Hutchence'
      ],
      fr: [
            'Franz Reichelt', 'Garry Hoy', 'Clement Vallandigham', 'Allan Pinkerton', 'Eschyle', 'Dracon',
            'Chrysippe de Soles', 'Adolphe-Frédéric de Suède', 'Isadora Duncan', 'Jack Daniel',
            'Sherwood Anderson', 'Jerome Irving Rodale', 'Tycho Brahe', 'Attila', 'Henry Hall (soldat)',
            'Bobby Leach', 'Sam Patch', 'Karel Soucek', 'Robert Overacker', 'Jimi Heselden',
            'Michael Anderson Godwin', 'Jim Fixx', 'Arrichion', 'Adrien IV', 'Sigurd Eysteinsson',
            'Béla Ier de Hongrie', 'Martin Ier d’Aragon', 'Frédéric Barberousse', 'Foulques V d’Anjou',
            'Thomas Midgley', 'Horace Wells', 'Alexandre Bogdanov', 'Marie Curie', 'Otto Lilienthal',
            'John Sedgwick', 'Basil Brown', 'Michael Rockefeller', 'Garrett Morgan', 'Marcus Garvey',
            'Émile Cohl', 'Hypatie', 'Empédocle', 'Zeuxis', 'L’Arétin', 'Hans Steininger', 'Qin Shi Huang',
            'Georges Plantagenêt', 'Édouard II d’Angleterre', 'Henri Ier d’Angleterre', 'Charles VIII',
            'Louis III de France', 'Jean Ier de Bohême', 'Guillaume le Conquérant',
            'Alexandre Ier de Grèce', 'Zachary Taylor', 'William Henry Harrison', 'Alexander Hamilton',
            'Button Gwinnett', 'Raspoutine', 'Francis Bacon (philosophe)', 'Kurt Gödel', 'Harry Houdini',
            'Jean-François Pilâtre de Rozier', 'Sophie Blanchard', 'Robert Cocking', 'Henry Winstanley',
            'Salomon August Andrée', 'Robert Falcon Scott', 'George Mallory', 'Percy Pilcher',
            'Aurel Vlaicu', 'Thomas Selfridge', 'Wan Hu', 'AVE Mizar', 'Mary Ward (scientifique)',
            'Bridget Driscoll', 'Larry Walters', 'Donald Campbell', 'Jessi Combs', 'Dale Earnhardt',
            'Gilles Villeneuve', 'Ayrton Senna', 'Louis Slotin', 'Harry Daghlian', 'Hisashi Ouchi',
            'Eben Byers', 'Clarence Dally', 'Radium Girls', 'Jack Parsons', 'Timothy Treadwell',
            'Steve Irwin', 'Karl Wallenda', 'Dan Osman', 'Christopher McCandless', 'Jeff Buckley',
            ...
            'Otis Redding', 'Terry Kath', 'Jon-Erik Hexum', 'Brandon Lee', 'Vic Morrow', 'Owen Hart',
            'Bandō Mitsugorō VIII', 'Tennessee Williams', 'Frank Hayes (jockey)', 'Ray Chapman',
            'Vladimir Smirnov (escrimeur)', 'Duk Koo Kim', 'Bill Masterton', 'Elisa Lam', 'Ryan Dunn',
            'David Carradine', 'Michael Hutchence'
      ]
    }
  }
