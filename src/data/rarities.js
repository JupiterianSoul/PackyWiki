...
export const RARITIES = [
  ...
  { id: 'rare',      name: { en: 'Rare', fr: 'Rare' },      weight: 17,   bonusPct: 60,   color: '#3b82f6', glow: 'rgba(59, 130, 246, 0.55)',  flash: 0.12 },
  { id: 'epic',      name: { en: 'Epic', fr: 'Épique' },      weight: 9,    bonusPct: 140,  color: '#c084fc', glow: 'rgba(192, 132, 252, 0.65)', flash: 0.3 },
  { id: 'legendary', name: { en: 'Legendary', fr: 'Légendaire' }, weight: 3.6,  bonusPct: 320,  color: '#fbbf24', glow: 'rgba(251, 191, 36, 0.75)',  flash: 0.55 },
  { id: 'mythic',    name: { en: 'Mythic', fr: 'Mythique' },    weight: 0.9,  bonusPct: 700,  color: '#e02134', glow: 'rgba(224, 33, 52, 0.8)',    flash: 0.72 },
  { id: 'exotic',    name: { en: 'Exotic', fr: 'Exotique' },    weight: 0.35, bonusPct: 1500, color: '#22d3ee', glow: 'rgba(34, 211, 238, 0.85)',  flash: 0.88 },
  { id: 'artifact',  name: { en: 'Artifact', fr: 'Artefact' },  weight: 0.15, bonusPct: 3200, color: '#fef08a', glow: 'rgba(254, 240, 138, 0.95)', flash: 1 }
];
